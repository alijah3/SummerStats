...
This report presents prelimiary data analysis for the week 3 Example Data. Specifically, this will report basic descriptive statistics as well as report tests of the following predictions:
...
5. People will be more genorous when:
  + 5.1 They caused the shock (vs. their partern)
  + 5.2 The partner was morally good (vs. bad)
  + 5.3 The shock was stronger (high > medium > low)
6. Women will be more generous than men 
7. Agreeableness people will be more generous 
...
#Run the correlation for prediction 3
...
Prediction 4 was not supported. Neurotic people were not more guitly:
```{r p4}

#Run the correlation for prediction 4
